...
public class TestInt3x3 {
	...
	static Stream<Arguments> testSource() {
		return Stream.of(
			...
			//4. Int3x3 + null (Float3x3)
			Arguments.of(a.asFloat(), a.plus(n2)),
			//5. Int3x3 + Double3x3
			...
			//24. Int3x3 * null (Int3)
			Arguments.of(Int3.ZERO, a.multiply(vn1)),
			//25. Int3x3 * Float3
			...
			//35. Int3x3 * null (Int3x3)
			Arguments.of(Int3x3.ZERO, a.multiply(n1)),
			//36. Int3x3 * Float3x3
