...
public class TestDouble2 {
	...
	static Stream<Arguments> testSource() {
		return Stream.of(
			...
			//23. Double2 ^ null (Double2)
			Arguments.of(Double.NaN, Double2.UP.angle(vn1)),
			//24. Double2 ^ Double2
			Arguments.of(Math.toRadians(90.0), Double2.UP.angle(Double2.RIGHT)),
			//25. Double2 ^ null (Float2)
			Arguments.of(Double.NaN, Double2.UP.angle(vn2)),
			//26. Double2 ^ (double, double)
