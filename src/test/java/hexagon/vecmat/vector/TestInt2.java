...
public class TestInt2 {
	...
	static Stream<Arguments> testSource() {
		return Stream.of(
			...
			//39. Int2 ^ null (Int2)
			Arguments.of(Double.NaN, Int2.UP.angle(vn1)),
			//40. Int2 ^ Float2
			Arguments.of(Math.toRadians(90.0), Int2.UP.angle(Float2.RIGHT)),
			//41. Int2 ^ null (Float2)
			Arguments.of(Double.NaN, Int2.UP.angle(vn2)),
			//42. Int2 ^ Double2
			Arguments.of(Math.toRadians(90.0), Int2.UP.angle(Double2.RIGHT)),
			//43. Int2 ^ null (Double2)
			Arguments.of(Double.NaN, Int2.UP.angle(vn3)),
			//44. Int2 ^ (double, double)
