...
public class TestInt3 {
	...
	static Stream<Arguments> testSource() {
		return Stream.of(
			...
			//48. Int3 ^ null (Int3)
			Arguments.of(Double.NaN, Int3.UP.angle(vn1)),
			//49. Int3 ^ Float3
			Arguments.of(Math.toRadians(90.0), Int3.UP.angle(Float3.FORWARD)),
			//50. Int3 ^ null (Float3)
			Arguments.of(Double.NaN, Int3.UP.angle(vn2)),
			//51. Int3 ^ Double3
			Arguments.of(Math.toRadians(90.0), Int3.UP.angle(Double3.FORWARD)),
			//52. Int3 ^ null (Double3)
			Arguments.of(Double.NaN, Int3.UP.angle(vn3)),
			//53. Int3 ^ (double, double)
