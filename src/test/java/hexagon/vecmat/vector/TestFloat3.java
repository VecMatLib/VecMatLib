...
public class TestFloat3 {
	...
	static Stream<Arguments> testSource() {
		return Stream.of(
			...
			//42. Float3 ^ null (Float3)
			Arguments.of(Double.NaN, Float3.UP.angle(vn1)),
			//43. Float3 ^ Double3
			Arguments.of(Math.toRadians(90.0), Float3.UP.angle(Double3.FORWARD)),
			//44. Float3 ^ null (Double3)
			Arguments.of(Double.NaN, Float3.UP.angle(vn3)),
			//45. Float3 ^ (double, double, double)
